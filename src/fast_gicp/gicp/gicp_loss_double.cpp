...
double gicp_loss(const Eigen::Vector3d& mean_A, const Eigen::Matrix3d& cov_A, const Eigen::Vector3d& mean_B, const Eigen::Matrix3d& cov_B, const Eigen::Matrix3d& R, const Eigen::Vector3d& t, Eigen::Matrix<double, 1, 12>* J, bool cov_derivative) {
  ...
  if(cov_derivative) {
    ...
    Eigen::Matrix<double, 3, 12> jd = dtransform(mean_A, mean_B, R, t);
    Eigen::Matrix<double, 3, 12> jRCRd = RCR_inv * jd;
